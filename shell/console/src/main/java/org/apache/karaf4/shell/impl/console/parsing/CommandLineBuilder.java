...
public class CommandLineBuilder {
    ...
    public static CommandLine build(String buffer, int cursor) {
        ...
        try {
            ...
            return new ArgumentList(pipe.toArray(new String[pipe.size()]), parser.c2, parser.c3, cursor, buffer);
        } catch (Throwable t) {
            return new ArgumentList(new String[] { buffer }, 0, cursor, cursor, buffer);
        }
    }
     ...
     */
    static class ArgumentList implements CommandLine {
         ...
         */
        public ArgumentList(String[] arguments, int cursorArgumentIndex, int argumentPosition, int bufferPosition, String buffer) {
