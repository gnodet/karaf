 ...
 * under the License.
 */
package org.apache.karaf4.shell.impl.console.standalone;
        ...
        while (urls.hasMoreElements()) {
            ...
            while (line != null) {
                ...
                if (line.length() > 0 && line.charAt(0) != '#') {
                    ...
                    if (org.apache.karaf4.shell.api.action.Action.class.isAssignableFrom(actionClass)) {
                        ...
                        if (cmd != null) {
                            ActionCommand command = new ActionCommand((Class<? extends org.apache.karaf4.shell.api.action.Action>) actionClass) {
                                @Override
